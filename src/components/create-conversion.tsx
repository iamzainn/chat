...
const Conversation = ({ conversation }: { conversation: any }) => {
	...
	const {selectedConversation,setSelectedConversation}=useConversationStore();
	  ...
	  const activeBgClass = selectedConversation?._id === conversation._id ? "bg-chat-hover" : "";
	

	return (
		<>
			<div className={`flex gap-2 items-center p-3 hover:bg-chat-hover cursor-pointer ${activeBgClass}`}
